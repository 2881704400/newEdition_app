...
function eventSearch_en() {
    ...
    var pickerModel = myApp.picker.create({
        ...
        renderToolbar: function() {
            return '<div class="toolbar">' + '<div class="toolbar-inner">' + '<div class="left">' + '<a href="#" class="link sheet-close popover-close">Cancel</a>' + '</div>' + '<div class="center">' + '<a href="#" class="link toolbar-randomize-link">Select device</a>' + '</div>' + '<div class="right">' + '<a href="#" class="link sheet-close popover-close">Confirm</a>' + '</div>' + '</div>' + '</div>';
        },
        cols: [{
            textAlign: 'center',
                ...
                $("#tab1").unbind('srcoll').bind('scroll', function() {
                    ...
                    if (nScrollTop + nDivHight >= nScrollHight && allowInfinite) {
                        ...
                        setTimeout(function() {
                            ...
                            var html = '',
                                lastItemIndexMax = lastItemIndex + itemsPerLoad;
